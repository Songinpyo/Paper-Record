...
|[OTPose: Occlusion-Aware Transformer for Pose Estimation in Sparsely-Labeled Videos](https://arxiv.org/abs/2207.09725](https://github.com/Songinpyo/Paper-Record/issues/16)[2022]|제한적인 receptive field를 가지는 CNN의 근본적 한계와 main challenge인 occlusion을 해결하기 위해 여러 프레임의 조합과 transformer를 이용해서 Occlusion aware heatmap, Occlusion Attension mask를 생성한다. Posetrack SOTA |
